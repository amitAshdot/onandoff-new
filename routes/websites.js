...
router.post('/',
    ...
    async (req, res) => {
        ...
        const { name, url, divId, date, timeSchedule, isShow, color, selected, swatches } = req.body;
        try {
...
router.put('/:id', auth, async (req, res) => {
    ...
    if (color) websitesFeilds.color = color;
    if (selected) websitesFeilds.selected = selected;
    if (swatches) websitesFeilds.swatches = swatches;
